package com.company.authservice.configurations.security;
...
public class AuthenticationProvider {
    ...
    public String createAccessToken(UUID userId, String fullName, Set<Role> roles) {
        Claims claims = Jwts.claims().setSubject(fullName);
    ...
    public String createRefreshToken(UUID userId, String fullName) {
        Claims claims = Jwts.claims().setSubject(fullName);
        claims.put("id", userId);
